...
<!-- Mirrored from malapericontact MALAPERI [XR&CO'2014], Wed, 29 Jan 2025 05:22:48 GMT -->
<head>
		<meta charset="UTF-8">
											...
											<div class="contact-content d-flex">
												...
												<div class="contact-inner">
													...
													<div class="description">
														<p>29 Street, Melbourne City <br>example@gmail.com</p>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="single-contact">
											<div class="contact-content d-flex">
												...
												<div class="contact-inner">
													...
													<div class="description">
														<p>Office: +1 226-507-0468.. <br>Office: +1 226-507-0468..</p>
													</div>
												</div>
											</div>
										</div>
										<div class="single-contact">
											<div class="contact-content d-flex">
												...
												<div class="contact-inner">
													...
													<div class="description">
														<p>From Monday – Friday. <br>8 am to 7 pm</p>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="control-contact-form">
										<form action="https://formspree.io/f/myyleorq" method="POST" id="dreamit-form">
											<div class="row">
												...
												<div class="col-lg-6 col-md-6">
													<div class="input-box">
														<input type="text" name="address" placeholder="Your City">
													</div>
												</div>
