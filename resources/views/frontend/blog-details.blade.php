...
<!-- Mirrored from malaperiblog-details MALAPERI [XR&CO'2014], Wed, 29 Jan 2025 05:22:50 GMT -->
<head>
		<meta charset="UTF-8">
					...
					<div class="col-lg-8">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="single-blog-list single-blog-details">
									<div class="blog-thumb blog-list-thumb">
										<img src="frontend/assets/images/blog-details.jpg" alt="blog img">
						...
						<div class="row comment-area">
							<div class="col-md-12 col-md-12 col-sm-12">
								<div class="single-widget-item blg-dtls-bar">
									<h2 class="widget-title">Leave Comment</h2>
								</div>
							</div>
							<div class="col-lg-12 col-md-12 col-sm-12"> 
								<div class="control-contact-form">
									<form action="https://formspree.io/f/myyleorq" method="POST" id="dreamit-form">
										<div class="row">
											...
											<div class="col-lg-6 col-md-6">
												<div class="input-box">
													<input type="text" name="address" placeholder="Your Website">
												</div>
											</div>
