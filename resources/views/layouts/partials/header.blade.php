...
<div class="app-brand-sm d-lg-none d-flex">
    <a href="index.html">
        <img src="backend/assets/images/logo-sm.svg" class="logo" alt="Axis Bootstrap Template" />
    </a>
</div>
<!-- App brand sm ends -->
...
<div class="header-actions">
                ...
                <div class="scroll250">
                    <div class="dropdown-item">
                        <div class="d-flex align-items-center py-2">
                            <img src="backend/assets/images/user1.png" class="img-4x me-3 rounded-5"
                                alt="Web Dashboards" />
                            <div class="m-0">
                    ...
                    <div class="dropdown-item">
                        <div class="d-flex align-items-center py-2">
                            <img src="backend/assets/images/user2.png" class="img-4x me-3 rounded-5"
                                alt="Web Dashboards" />
                            <div class="m-0">
                    ...
                    <div class="dropdown-item">
                        <div class="d-flex align-items-center py-2">
                            <img src="backend/assets/images/user3.png" class="img-4x me-3 rounded-5"
                                alt="Web Dashboards" />
                            <div class="m-0">
                    ...
                    <div class="dropdown-item">
                        <div class="d-flex align-items-center py-2">
                            <img src="backend/assets/images/user4.png" class="img-4x me-3 rounded-5"
                                alt="Web Dashboards" />
                            <div class="m-0">
    ...
    <div class="dropdown ms-4">
        <a id="userSettings" class="dropdown-toggle d-flex py-2 align-items-center" href="#!"
            ...
            <img src="backend/assets/images/user.png" class="rounded-4 img-3x" alt="Bootstrap Gallery" />
